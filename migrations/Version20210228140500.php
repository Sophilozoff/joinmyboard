 ...
 */
final class Version20210228140500 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_boardgame (user_id INT NOT NULL, boardgame_id INT NOT NULL, INDEX IDX_984156F9A76ED395 (user_id), INDEX IDX_984156F9B1A27A21 (boardgame_id), PRIMARY KEY(user_id, boardgame_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event_boardgame (event_id INT NOT NULL, boardgame_id INT NOT NULL, INDEX IDX_1E34E52071F7E88B (event_id), INDEX IDX_1E34E520B1A27A21 (boardgame_id), PRIMARY KEY(event_id, boardgame_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
